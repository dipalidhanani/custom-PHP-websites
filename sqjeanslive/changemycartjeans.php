...

{
		...
		$selectedspecialnoteforthisjeans=$rowsetselected['bill_submitted_special_note'];
...

						 {
							...
							$selectedmeasurementforthisjeans[$p]=$rowsetselected["bill_submitted_measurement".$k];
		...
		$selectedthisjeansfor=$rowsetselected['bill_submitted_jeans_for'];

		$selectedthisjeansgender=$rowsetselected['bill_submitted_jeans_gender'];

		$selectedthisjeansspecialnote=$rowsetselected['bill_submitted_special_note'];
...
if($display_order_for==2){
			 ...
			 ?>
              ...
              <tr>
                ...
                <td align="left"><table width="100%" border="0"  background="images/pgbg02a.jpg" class="border3"  cellpadding="0" cellspacing="0" >
        ...
        <?php
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="left"><table width="100%"  background="images/pgbg02a.jpg" class="border3"   border="0" cellpadding="5" cellspacing="0" >
         ...
         <?php
          ...
          <td><table width="100%" border="0" cellpadding="5" cellspacing="0" >
                  ...
                  <tr>
                    ...
                    <td class="titel"><h3>Change buttonrivets style</h3></td>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top"><table width="120" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td height="110" align="center" valign="middle"><a href="images/buttonrivets/<?php echo $rowbuttonrivets["buttonrivets_image"];?>" rel="lightbox" title="<?php echo $rowbuttonrivets["buttonrivets_name"];?>"><img src="images/buttonrivets/p<?php echo $rowbuttonrivets["buttonrivets_image"];?>" alt="<?php echo $rowbuttonrivets["buttonrivets_name"];?>" title="<?php echo $rowbuttonrivets["buttonrivets_name"];?>" border="0" /></a></td>
                            ...
                            <tr>
                              ...
                              <td align="center"><input type="radio" name="selectedbuttonrivetsstyle" id="selectedbuttonrivetsstyle" value="<?php echo $rowbuttonrivets["buttonrivets_ID"];?>" onclick="calculate_youselected('ResultPanel_youselected','youselected.php',nextstepform)" <?php if(($selectedbuttonrivetsstyleforthisjeans==$rowbuttonrivets["buttonrivets_ID"])||($rowbuttonrivets["buttonrivets_default"]==1)) { ?> checked="checked" <?php } ?>/></td>
		...
		{			
          ...
          <td><table width="100%" border="0" cellpadding="5" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td align="center" class="font10"><table width="100%" border="0"  background="images/pgbg02a.jpg" class="border3"  cellspacing="0" cellpadding="0" >
...
If you want access or less loosing then the loosing shown in the  table, please describe them in the last box  "Special Notes" below.</span></td>
                  ...
                  <tr id="show_customfittingtypetr" <?php if($selectedjeanstypeforthisjeans==1) { ?> style="display:none;" <?php } ?>>
                    ...
                    If you already have a perfect jeans and you like it the most, then you can send us all the measurements by following the instructions in Copy A Jeans section. We will make the perfect copy of your favorite jeans                    </td>
...
<tr><td colspan="5" align="left" class="font10"><strong>Gender&nbsp;:&nbsp;</strong> <?php echo $selectedthisjeansgender; ?></td></tr>
        ...
        <tr>
            ...
            <input type="hidden" name="selection" value="<?php echo $_REQUEST["selection"];?>" />           

            <input type="hidden" name="action" value="changemycart" />
