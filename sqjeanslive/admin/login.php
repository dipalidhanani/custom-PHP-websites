     ...
     <form method="post" name="frmadminlogin" id="frmadminlogin" action="loginprocess.php" >
      ...
      <tr>
        ...
        <td style="background-repeat:repeat-x"><table width="100%" border="0" cellpadding="0" cellspacing="2">
          ...
          <tr>
            <td height="22" align="left" class="normal_fonts12_black" >Username</td>
          </tr>
          <tr>
            <td height="22" align="left" ><input name="adminusername" type="text" class="normal_fonts9" id="adminusername" /></td>
            </tr>   
          <tr>
            <td height="22" align="left" class="normal_fonts12_black">Password</td>
            </tr>
          <tr>
            <td height="22" align="left"><input name="adminpassword" type="password" class="normal_fonts9" id="adminpassword" /></td>
            </tr>
        </table></td>
        </tr>
      <tr>
        ...
        <td align="left" valign="middle" background="images/box_bg_05.jpg" style="background-repeat:repeat-x"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td class="warning_fonts9"><strong><?php echo "Invalid username and password."; ?></strong></td>
            </tr>
            <?php
				}
				?>
