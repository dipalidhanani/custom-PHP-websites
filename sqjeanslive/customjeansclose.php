              ...
              <td><table width="100%" border="0"   cellspacing="0" cellpadding="0">
                <tr>
                 ...
                 <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                  <td height="25" align="center" valign="top" class="titel"><h1>We have stop accepting orders till 31 May 2012 due to overload work.<br />
Sorry for inconvenience !!<br />
Thank you for visiting SQ Jeans.</h1></td>
                 </tr>
