...
<title>SQ Custom Jeans | Contact Us</title>
<table width="100%" border="0" cellspacing="5" cellpadding="0">
                      <tr>
                        <td align="left" valign="top" class="font10"><table width="100%"  background="images/pgbg02a.jpg" class="border3" border="0"  cellspacing="0" cellpadding="5">
                          <tr>
                             <td colspan="3" align="center"><h1>Contact Us</h1></td>
                          </tr>
                          <tr>
                            <td width="36%" align="right" valign="top"><b>Contact Person</b></td>
                            <td width="2%" align="center" valign="top"><strong>:</strong></td>
                            <td width="62%" valign="top">Mr. Hitesh Sodiwala</td>
                          </tr>
                          <tr>
                            <td align="right" valign="top"><b>Address</b></td>
                            <td align="center" valign="top"><strong>:</strong></td>
                            <td valign="top">2/1657, Zunda Street,<br />
                                Sagrampura,<br />
                                Surat,<br />
                                Gujarat  - 395002<br />
                                India
                          ...
                          <tr>
                            <td align="right" valign="top"><b>Contact Numbers</b></td>
                            <td align="center" valign="top"><strong>:</strong></td>
                            <td valign="top">+91 9909 133 233 <font color="#FF0000">(10.00 AM-08.00 PM)</font><br>
                              +91 9898 239 839 <font color="#FF0000">(10.00 AM-08.00 PM - Viber, Whatsapp)</font></td>                          
                            
                          </tr>
                          <tr>
                            <td align="right" valign="top"><b>Email</b></td>
                            <td align="center" valign="top"><strong>:</strong></td>
                            <td valign="top">info@sqjeans.com<br />sqjeans@yahoo.com</td>
                          </tr>
                          <tr>
                      ...
                      <tr>
                        <td align="left" valign="top" class="font10"><table width="100%" border="0" background="images/pgbg02a.jpg" class="border3"cellspacing="0" cellpadding="5">
                              <form name="contactusform" method="post" action="process.php">
                                <tr>
                                  <td colspan="4" align="center" valign="top" class="titel_2"><h1>Send Your Inquiry</h1></td>
                                </tr>
								<?php
								if($_REQUEST["msg"]=="yes")
								{
								?>                                
                                <tr>
                                  <td colspan="4" align="center" valign="top"><font color="#FF0000"><b>Thank you for inquiry to SQ Jeans<br />
                                  Your inquiry has been sent to SQ Jeans Team successfully<br />
                                  </b></font></td>
                                </tr>
                                <?php
								}
								?>
                                <tr>
                                  <td width="36%" align="right" valign="top"> <strong>Name</strong></td>
                                  <td width="2%" align="center" valign="top"><strong>:</strong></td>
                                  <td colspan="2" valign="top" ><font color="#FF0000"><b>
                                    <input type="text" size="50" name="name" class="font9"/>
                                  </b></font></td>
                                </tr>
                                <tr>
                      ...
                      <option value="Zimbabve">Zimbabve</option>
                                ...
                                <tr id="erroralready" style="display:none;">
                                  <td colspan="4" valign="top"><table width="50%" border="0" cellspacing="0" cellpadding="0" align="center">
                                    <tr>
