...
if(count($_SESSION['sqjeanscart'])>=5)
{
		...
		{
			echo "<script type=\"text/javascript\">document.location.href='index.php?object=2&step=4'; </script>\n";
		}
		else
		{
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" class="titel_2"><strong>Custom Jeans</strong></td>
              </tr>
              <tr>
                <td height="10"></td>
              </tr>
          ...
          <td><table width="100%" border="0" cellspacing="5" cellpadding="0" >
            <tr>
              <td><table width="100%" border="0"   cellspacing="0" cellpadding="0">
                ...
                <?php
			 $query="SELECT * FROM material_master where material_available=1 order by material_display_order";			
			 ...
			 ?>
                <tr>
                  <td align="left"><table width="100%" height="57" border="0" cellpadding="0" cellspacing="5"  background="images/pgbg02a.jpg"  class="border3">
                       <tr>
                         <td class="font9" align="center"><h1>We have stop accepting orders till 31 May 2012 due to overload work.<br />
                         Sorry for inconvenience !!<br />Thank you for visiting SQ Jeans.</h1></td>
                       </tr>
                    </table></td>
                  </tr>
                <tr>
...
<form name="nextstepform" method="get" action="index.php">
  <tr>
    ...
    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="left">
          <a href="index.php?object=2"><img src="images/button_prev.jpg" border="0" /></a></td>
...
if($_SESSION['selectedmaterialid']=="")
{
			  	echo "<script type=\"text/javascript\">document.location.href='index.php?object=2&step=2'; </script>\n";
}
?>
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
                ...
                <td><table width="100%" background="images/pgbg02a.jpg" border="0" cellspacing="0" cellpadding="0" class="border3">
                  ...
                  <tr>
                    ...
                    <td align="left" class="font10"><table width="610" border="0" cellpadding="5" cellspacing="0">
                      ...
                      <tr>
                        <td width="26"><input type="radio" name="selectedjeanstype" value="1" onclick="display_meassurementdetails()"/></td>
                        <td width="247"><strong>Make My Jeans</strong>                         </td>
                        <td width="20"><input type="radio" name="selectedjeanstype" value="2" onclick="display_meassurementdetails()"/></td>
                    ...
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="5">
                      ...
                      <tr>
                        <td align="center" class="font9"><span class="font10"><strong>Choose one option as per your required fitting, and measurement form will appear</strong></span>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="15" align="center"><span class="red_font10">Amount to add / reduce on your original body measurements</span></td>
    </tr>
  <tr>
    <td align="center"><table width="100%" border="0" cellpadding="1" cellspacing="1" class="border3">
  <tr>
    <td width="19%" align="left" valign="middle"  >&nbsp;</td>
    <td width="16%" align="center" valign="middle" ><strong>Super Skinny</strong></td>
    <td width="13%" align="center" valign="top"><strong>Skinny</strong></td>
    <td width="13%" align="center" valign="top" ><strong>Slim</strong></td>
    <td width="12%" align="center" valign="top" ><strong>Straight</strong></td>
    <td width="13%" align="center" valign="top" ><strong>Comfort</strong></td>
    <td width="14%" align="center" valign="top" ><strong>Baggy</strong></td>
  </tr>
  <tr>
    <td align="left" valign="middle" ><strong>More or Less At</strong></td>
    <td align="center" valign="middle" ><strong>
      <input type="radio" name="jeansfittingtype" value="Super Skinny" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
    <td align="center" valign="top" ><strong>
      <input type="radio" name="jeansfittingtype" value="Skinny" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
    <td align="center" valign="top" ><strong>
      <input type="radio" name="jeansfittingtype" value="Slim" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
    <td align="center" valign="top" ><strong>
      <input type="radio" name="jeansfittingtype" value="Straight" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
    <td align="center" valign="top" ><strong>
      <input type="radio" name="jeansfittingtype" value="Comfort" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
    <td align="center" valign="top" ><strong>
      <input type="radio" name="jeansfittingtype" value="Baggy" onclick="display_meassurementdetails_tr()"/>
    </strong></td>
  </tr>
  <tr>
    <td align="left" valign="top">Seat</td>
    <td align="center" valign="top" class="fontred9">-2.50"</td>
    <td align="center" valign="top" class="fontred9">-1.00"</td>
  ...
  <tr>
    ...
    <td align="center" valign="top" class="fontred9"  >-2.00"</td>
    <td align="center" valign="top" class="fontred9"  >-1.00"</td>
    <td align="center" valign="top"  >0.00"</td>
    <td align="center" valign="top"  >+1.00"</td>
  ...
  <tr>
    ...
    <td align="center" valign="top" class="fontred9">-1.50"</td>
    <td align="center" valign="top" class="fontred9">-0.50"</td>
    <td align="center" valign="top">0.00"</td>
    <td align="center" valign="top">+1.00"</td>
  ...
  <tr>
    ...
    <td colspan="6" align="center" valign="top"  >Write the actual bottom measurement you want for your jeans</td>
    </tr>
    </table></td>
    </tr>
</table></td>
                    ...
                    <td ><table width="100%" border="0" cellspacing="0" cellpadding="5">
                      ...
                      <tr>
                        <td align="left" class="font10"><strong>Gender :</strong>
                          <input type="radio" name="jeansgender" value="Male" checked="checked" />
  &nbsp;Male&nbsp;
  <input type="radio" name="jeansgender" value="Female"/>
  &nbsp;Female</td>
                        </tr>
                      <tr>
                        <td align="left" class="font10"><table border="0" cellspacing="0" cellpadding="1">
                        <?php
						 $md=0;
						 $m=1;
						 $query="SELECT * FROM measurement_master where measurement_available=1 order by measurement_ID";			
						 ...
						 ?>  
                        <tr>
                        <td width="21" align="right" class="font10"><?php echo $m;?>.</td>
                        <td width="114" class="font10"><?php echo $rowmeasurement["measurement_name"];?>
                        <?php
                          ...
                          <?php
						   ...
						   ?>                        </td>
                        <td width="75"><input name="measurement<?php echo $m;?>" type="text" class="font9" size="10" value="<?php echo $_SESSION["savemeasurement".$m];?>" <?php if($m==4) { ?> onfocus="calculate_youselected('ResultPanel_youselected','youselected.php',nextstepform)" <?php } ?>/>
                        <?php
						
						?>                        </td>
                        <td width="21">&quot;</td>
                        <td width="272"><img src="images/QuestionMark.gif" width="19" height="19" border="0" onclick="return hs.htmlExpand(this, { headingText: '<?php echo $rowmeasurement["measurement_name"];?> - Make My Jeans' })" style="cursor:pointer;"/>
                    ...
                    ?></td>
                          ...
                          How to Measure &quot;<?php echo $rowmeasurement["measurement_name"];?>&quot;</td>
                      </tr>
                      <?php			 
					 $m++;
					 }
        ...
        <tr>
          <td align="left"><a href="index.php?object=2&step=2"><img src="images/button_prev.jpg" border="0" /></a></td>
    ...
    <form name="nextstepform" method="get" action="index.php">
        <tr>
          <td width="100%" colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"colspan="2" class="titel_2"><strong>Your Cart</strong></td>
                </tr>
              <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <tr>
				...
				?>
                  ...
                  <B>Shipping Rates Information</B>
                  </p>
                  <?php
				  }
				  ?>
