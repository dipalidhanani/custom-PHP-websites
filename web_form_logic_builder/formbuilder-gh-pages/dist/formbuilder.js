...
(function() {
  Formbuilder.registerField('section_break', {
    ...
    view: "",
    edit: "",
    addButton: "<span class='symbol'><span class='fa fa-font'></span></span> Header Text",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
(function() {
  Formbuilder.registerField('file', {
    ...
    edit: "<%= Formbuilder.templates['edit/size']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>",
    addButton: "<span class='symbol'><span class='fa fa-font'></span></span> File",
    defaultAttributes: function(attrs) {
      attrs.field_options.size = 'small';
      return attrs;
    }
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<div class=\'wrapper-back\'><a href="javascript: history.go(-1)">Back</a></div><div class=\'fb-save-wrapper\'>\n  <button class=\'js-save-form ' +
((__t = ( Formbuilder.options.BUTTON_CLASS )) == null ? '' : __t) +
'\'></button>\n</div>';
...
__p += '\n    <abbr title=\'required\'><strong>(Do Not Delete)</strong></abbr>\n  ';
 } ;
__p += '\n</label>\n';
