...
$pagename = ( isset($_GET['page']) ) ? $_GET['page'] : "login";
	...
	$pagename = ( isset($_GET['page']) ) ? $_GET['page'] : "my-account";	
		}
$pagename .= ".php";
?>
<!doctype html>
...
<title>Forex Locus - www.forexlocus.com</title>
...
<table border="0" cellpadding="0" cellspacing="0" class="table_width" align="center">
	<tr><td><table border="0" align="center" cellspacing="0" class="maintable">
		<tr>
			...
			<td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td align="center" valign="top" class="content logo"><h1><img src="images/Ver2.png" alt="Logo"></h1></td>
				</tr>
			</table></td>
		</tr>
		<tr>
  ...
  <tr>
    ...
    <ul>
       ...
       <li> <a href="index.php?page=my-account">My Progress</a></li>
       <li> <a href="" onclick="window.open('index.php?page=new_journal','mywindow','width=700,height=700,fullscreen=yes,scrollbars=yes')">New</a></li>      
       <li> <a href="index.php?page=export_data">Export Data</a></li>      
       ...
       <li> <a href="index.php?page=changepasswd">Change Password</a></li>
