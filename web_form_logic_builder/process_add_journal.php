...
$ins_journal = mysql_query("insert into journal_form_master(user_master_id,journal_entry_title,journal_entry_status,journal_entry_priority,journal_entry_date,potential_take_profit,new_potential_take_profit,pips_earned_lost,potential_entry_price,new_potential_entry_price,actual_entry_price,potential_account_risk,new_potential_account_risk,actual_potential_account_risk,what_potential_account_risk,potential_risk_to_reward,new_potential_risk_to_reward,actual_potential_risk_to_reward) values('".$_SESSION["user_id"]."','".$_REQUEST['journal_entry_title']."','".$_REQUEST['journal_entry_status']."','".$_REQUEST['journal_entry_priority']."','".$_REQUEST['journal_entry_date']."','".$_REQUEST['potential_take_profit']."','".$_REQUEST['new_potential_take_profit']."','".$_REQUEST['pips_earned_lost']."','".$_REQUEST['potential_entry_price']."','".$_REQUEST['new_potential_entry_price']."','".$_REQUEST['actual_entry_price']."','".$_REQUEST['potential_account_risk']."','".$_REQUEST['new_potential_account_risk']."','".$_REQUEST['actual_potential_account_risk']."','".$_REQUEST['what_potential_account_risk']."','".$_REQUEST['potential_risk_to_reward']."','".$_REQUEST['new_potential_risk_to_reward']."','".$_REQUEST['actual_potential_risk_to_reward']."')"); 
...
if($json_string_arr_single['field_type'] == 'file'){
 ...
 values('".$_SESSION["user_id"]."','".$ins_journal_insert_id."','".$id_field."','".$form_image."')");
}else{
	if($json_string_arr_single['field_type'] == 'checkboxes'){
	 $checkBox = implode(',', $_REQUEST[$json_string_arr_single['cid']]);
	 $ins_journal_det = mysql_query("insert into journal_form(journal_user_master_id,journal_master_id,journal_field_master_id,journal_form_field_value) 
 values('".$_SESSION["user_id"]."','".$ins_journal_insert_id."','".$id_field."','".$checkBox."')");
	}
	else{		
		  $ins_journal_det = mysql_query("insert into journal_form(journal_user_master_id,journal_master_id,journal_field_master_id,journal_form_field_value) 
 values('".$_SESSION["user_id"]."','".$ins_journal_insert_id."','".$id_field."','".$_REQUEST[$json_string_arr_single['cid']]."')");
	}
}
}
		 }
