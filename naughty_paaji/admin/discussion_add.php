...
<table width="100%" border="0" cellspacing="10" cellpadding="0">
  ...
  <tr>
    <td align="right" class="normal_fonts9" bgcolor="#F3F3F3" valign="top">Discussion topic : </td>
    <td class="normal_fonts9" bgcolor="#F3F3F3"><input name="discussion_topic" type="text" class="normal_fonts9" id="discussion_topic" size="83" onblur="validation1(1)" />&nbsp;&nbsp;<span id="errdiscussion_topic" style="display:none" class="err_validate" >Please enter Topic</span>
  ...
  <tr>
	...
	<?php
				 ...
				 $code = $ckeditor->editor('discussion_description', '',$config);
				 echo $code;
				 ?>
                 </td>
  </tr>
