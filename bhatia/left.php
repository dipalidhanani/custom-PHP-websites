...
<table width="220" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><table width="220" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="112"><a  onclick='UncheckedAll();'><img src="<?php echo HTTP_BASE_URL; ?>images/reset_filters.jpg" width="112" height="25" border="0" style="cursor:pointer;" /></a></td>
                 ...
                 <!-- <tr>
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td align="center" valign="middle"><input type="image" src="<?php echo HTTP_BASE_URL_ORDER; ?>images/search_btn.jpg" border="0" name="search" value="Search" /></td>
      ...
      <tr>
            <td bgcolor="#F0ECEE" height="10"></td>
          </tr>
  ...
  <tr>
    <td class="border1"><?php include('home_right.php'); ?></td>
  </tr>
  <tr>
    <td height="10"></td>
  </tr>
  <tr>
    <td class="border1"><?php include('facebook_like.php'); ?></td>
  </tr>
