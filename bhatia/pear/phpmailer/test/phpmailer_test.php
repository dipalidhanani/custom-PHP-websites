...
require("phpunit".$G_phpextension);
require($INCLUDE_DIR . "class.phpmailer".$G_phpextension.);
...
class phpmailerTest extends TestCase
{
    ...
    function test_Multiple_Plain_FileAttachment() {
        ...
        if(!$this->Mail->AddAttachment("phpmailer_test".$G_phpextension, "test.txt"))
        {
            $this->assert(false, $this->Mail->ErrorInfo);
            return;
        }
    ...
    function test_HTML_Attachment() {
        ...
        if(!$this->Mail->AddAttachment("phpmailer_test".$G_phpextension, "test_attach.txt"))
        {
            $this->assert(false, $this->Mail->ErrorInfo);
            return;
        }
