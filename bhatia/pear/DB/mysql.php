 ...
 * @version    CVS: $Id: mysql.php5,v 1.117 2005/03/29 15:03:26 danielc Exp $
 ...
 */
 /*
  sniPEAR change control
  date 27.06.2006
  changed line
    require_once 'DB/common.php5';
  to
    require_once 'common.php5';

  Reason being that we are n ot relying on php installs actually having the PEAR DB unit installed
 */
//print $G_phpextension;
//die;
require_once 'common'.$G_phpextension;
