    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="99%" border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td class="normal_fonts14_black">Product Specification Category Title Details</td>
            </tr>
          <tr>
            <td bgcolor="#CCCCCC">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="4" class="normal_fonts8">
              <tr>
                ...
                <td width="100" align="left" valign="middle" bgcolor="#999999"><strong>Title</strong></td>
              ...
              <tr bgcolor="<?php echo $color; ?>">
               <td><?php 
			   $cat_detail=mysql_query("select * from prod_desc_cat where Prod_Desc_Cat_Id='".$k['Prod_Desc_Cat_Id']."'");
			   $ct=mysql_fetch_array($cat_detail);
			   echo $ct['Category'];
			    ?></td>
               ...
               <td><?php echo $k['Description']; ?></td>
                <td width="60"><table width="60" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center"><a href="cat_title_add.php?eid=<?php echo $k['Title_Id']; ?>"><img src="images/edit.png" alt="Edit" width="20" height="20" border="0" title="Edit" /></a></td>
                    <td align="center"><a href="cat_title_delete.php?eid=<?php echo $k['Title_Id']; ?>"><img src="images/delete_on.gif" alt="Delete" width="20" height="20" border="0" title="Delete" /></a></td>
                  </tr>
                </table></td>
                </tr>
                 <?php $i++; } ?> 
          ...
          <tr>
            <td align="center" valign="middle" class="normal_fonts10"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td align="left" valign="middle"><table width="238" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="25" align="left"><a href="cat_title_add.php"><img src="images/add.png" alt="Add" width="20" height="20" border="0" title="Add"/></a></td>
                    <td width="500" align="left" class="normal_fonts9"><a href="cat_title_add.php">Add New Category Title</a></td>
                  </tr>
                </table></td>
                <td width="300" align="right" valign="middle">
                <?php
			$sql=$query;
			$query="SELECT COUNT(*) as num FROM prod_title ".substr($query,47,strlen($query)) ;
			echo pages_wherequery($query,$sql,$perpage,"cat_title.php?"); 
				?>
                </td>
              </tr>
            </table>
