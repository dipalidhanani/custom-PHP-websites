    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td class="normal_fonts14_black">Bhatia Mobile Slider Details</td>
            </tr>
          <tr>
            <td bgcolor="#CCCCCC">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="4" class="normal_fonts8">
			  ...
			  ?>
              <tr>
                <td bgcolor="#FFFFFF"><img src="../slider_images/<?php echo $k['Is_Image']; ?>"  border="0" /></td>
                <td bgcolor="#FFFFFF"><?php echo $k['Disp_Order']; ?></td>
                <td bgcolor="#FFFFFF"><?php echo $k['Page_Link']; ?></td>
                  ...
                  <tr>
                    <td align="left" valign="middle"><table width="130" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td align="left" class="normal_fonts9"><a href="slider_add.php?pid=<?php echo $_REQUEST['eid'] ?>">Add New Slider</a></td>
                      </tr>
                    </table></td>
                    <td width="300" align="right" valign="middle" class="normal_fonts10"><?php
			$sql=$query;
			$query="SELECT COUNT(*) as num FROM slider_mst ".substr($query,24,strlen($query)) ;
			echo pages_wherequery($query,$sql,$perpage,"slider.php?"); 
				?></td>
                  </tr>
                </table></td>
                </tr>
