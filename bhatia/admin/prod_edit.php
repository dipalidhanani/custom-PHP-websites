          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="border">
              ...
              <tr>
				...
				{
				?>
                <option value="<?php echo $disp_os['Mobile_OS_Id']; ?>" <?php if($k['Prod_Mobile_OS']==$disp_os['Mobile_OS_Id']) { ?> selected="selected" <?php } ?>><?php  echo $disp_os['Mobile_OS'];?></option>
                <?php }?>
                </select></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#f3f3f3" class="normal_fonts9"><label>
                  <input type="radio" name="model" value="GSM" id="gsm" <?php if($k['Tech_Type']=='GSM' || $k['Tech_Type']==''){  ?> checked="checked" <?php } ?> />
                  GSM</label>
                  <label>
			...
			$count++;
              ...
              <tr>
                ...
                <td bgcolor="#FFFFFF" class="normal_fonts9"><label>
                  <input type="radio" name="active" value="1" id="active_0" <?php if($k['Is_Active']=='1' || $k['Is_Active']==''){  ?> checked="checked" <?php } ?> />
                  Active</label>
                  <label>
              ...
              <tr>
                ...
                <td bgcolor="#f3f3f3" class="normal_fonts9"><label>
                  ...
                  Yes</label>
                  <label>
                    <input type="radio" name="tablet" value="0" id="tablet_1" <?php if($k['Is_Tablet']=='0' || $k['Is_Tablet']==''){  ?> checked="checked" <?php } ?>  />
                    No</label></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="3" align="left" valign="top" bgcolor="#FFFFFF" class="normal_fonts10"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
              ...
              <tr>
                <td colspan="3" align="left" bgcolor="#FFFFFF" class="normal_fonts14_black">Product Specification</td>
                </tr>
              <?php 
