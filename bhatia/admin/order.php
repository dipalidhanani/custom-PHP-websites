              ...
              <tr>
                <td colspan="3" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="25" class="normal_fonts10"><strong>OR</strong></td>
                    <td align="left" valign="middle" class="normal_fonts10">
                    <form method="get" action="#" name="frmtxnid">
                    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="border">
                      <tr>
                        <td>Transaction Id</td>
                        <td align="center" valign="middle">:</td>
                        <td>&nbsp;</td>
                        <td><input name="txnno" type="text" id="txnno" size="15" /></td>
                        <td><input type="submit" name="txnsearch" value="Go" /></td>
                      </tr>
                    </table>
                    </form>
                    </td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="4" class="normal_fonts8">
              <tr>
			   ...
			   else if($_REQUEST['txnsearch']!='')
			   {
				   $query="select * from order_mst,prod_order_mst WHERE  prod_order_mst.order_invoice_Id like'%".$_REQUEST['txnno']."%' and order_mst.Is_Cancelled='0' and order_mst.Order_Id=prod_order_mst.Order_Id order by order_mst.Order_Id Desc";
			   }
			   else
			   {
				   $query="select * from order_mst order by  Order_Id desc";
