        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="border">
              <tr>
                <td width="300" align="right" valign="top" bgcolor="#FFFFFF" class="normal_fonts9"> Brand Name</td>
                <td width="10" align="center" valign="top" bgcolor="#FFFFFF" class="normal_fonts9">:</td>
