        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="border">
              <tr>
                <td width="300" align="right" valign="top" bgcolor="#f3f3f3" class="normal_fonts9"> Brand Name</td>
              ...
              <tr>
                <td align="right" valign="top" bgcolor="#FFFFFF" class="normal_fonts9">Select Mobile OS</td>
                <td align="center" valign="top" bgcolor="#FFFFFF" class="normal_fonts9">:</td>
                <td bgcolor="#FFFFFF" class="normal_fonts9"><select name="mobile_os" id="mobile_os">
                <?php
				$os_data=mysql_query("SELECT * FROM mobile_os ORDER BY Mobile_OS");
				while($disp_os=mysql_fetch_array($os_data))
				{
				?>
                <option value="<?php echo $disp_os['Mobile_OS_Id']; ?>"><?php  echo $disp_os['Mobile_OS'];?></option>
                <?php }?>
                </select></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td bgcolor="#f3f3f3" class="normal_fonts9"><label>
                  <input type="radio" name="model" value="GSM" id="gsm" checked="checked"/>
                  GSM</label>
                  <label>
                    <input type="radio" name="model" value="CDMA" id="cdma"  />
                    CDMA</label>
                    <label>
                    <input type="radio" name="model" value="BOTH" id="both" />
                    BOTH</label>
                    </td>
              </tr>
              <tr>
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF" class="normal_fonts9">:</td>
                <td bgcolor="#FFFFFF" class="normal_fonts9"><input name="color" type="text" class="normal_fonts9" id="color"                  size="40" /> 
              ...
              <tr>
				...
				{
				?>
                <option value="<?php echo $o['OfferId']; ?>"><?php echo $o['Offer']; ?></option>
                <?php } ?>
                </select></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#FFFFFF" class="normal_fonts9"><label>
                  <input type="radio" name="active" value="1" id="active_0" checked="checked"/>
                  Active</label>
                  <label>
              ...
              <tr>
                ...
                <td align="center" valign="top" bgcolor="#FFFFFF" class="normal_fonts9">:</td>
                <td align="left" valign="top" bgcolor="#FFFFFF" class="normal_fonts9"><textarea name="descr" id="descr" cols="50" rows="5"></textarea></td>
              </tr>
              <tr>
                <td align="right" bgcolor="#f3f3f3" class="normal_fonts9">Is Tablet </td>
                <td align="center" valign="top" bgcolor="#f3f3f3" class="normal_fonts9">:</td>
                <td bgcolor="#f3f3f3" class="normal_fonts9"><label>
                  <input type="radio" name="tablet" value="1" id="tablet_0"  />
                  Yes</label>
                  <label>
                    <input type="radio" name="tablet" value="0" id="tablet_1" checked="checked"/>
                    No</label></td>
              </tr>
              <tr>
                <td colspan="3" align="left" bgcolor="#FFFFFF" class="normal_fonts14_black">Mobile Features </td>
                </tr>
              <tr>
                <td colspan="3" align="left" bgcolor="#FFFFFF" class="normal_fonts10"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td width="20" align="center" valign="middle"><input name="is_3g" type="checkbox" id="is_3g" value="1" /></td>
                    <td align="left" valign="middle">3G</td>
                    <td width="20" align="center" valign="middle"><input name="is_bluetooth" type="checkbox" id="is_bluetooth" value="1" /></td>
                    <td align="left" valign="middle">Bluetooth</td>
                    <td width="20" align="center" valign="middle"><input name="is_camera" type="checkbox" id="is_camera" value="1" /></td>
                    <td align="left" valign="middle">Camera</td>
                    <td width="20" align="center" valign="middle"><input name="is_dualsim" type="checkbox" id="is_dualsim" value="1" /></td>
                    <td align="left" valign="middle">Dual SIM</td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle"><input name="is_FM_radio" type="checkbox" id="is_FM_radio" value="1" /></td>
                    <td align="left" valign="middle">FM Radio</td>
                    <td align="center" valign="middle"><input name="is_infrared" type="checkbox" id="is_infrared" value="1" /></td>
                    <td align="left" valign="middle">Infrared</td>
                    <td align="center" valign="middle"><input name="is_memory_slot" type="checkbox" id="is_memory_slot" value="1" /></td>
                    <td align="left" valign="middle">Memory Slot</td>
                    <td align="center" valign="middle"><input name="is_qwerty" type="checkbox" id="is_qwerty" value="1" /></td>
                    <td align="left" valign="middle">QWERTY</td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle"><input name="is_secondary_camera" type="checkbox" id="is_secondary_camera" value="1" /></td>
                    <td align="left" valign="middle">Secondary Camera</td>
                    <td align="center" valign="middle"><input name="is_smartphone" type="checkbox" id="is_smartphone" value="1" /></td>
                    <td align="left" valign="middle">SmartPhone</td>
                    <td align="center" valign="middle"><input name="is_touchscreen" type="checkbox" id="is_touchscreen" value="1" /></td>
                    <td align="left" valign="middle">Touchscreen</td>
                    <td align="center" valign="middle"><input name="is_video_recording" type="checkbox" id="is_video_recording" value="1" /></td>
                    <td align="left" valign="middle">Video Recording</td>
                  </tr>
                  <tr>
                    <td align="center" valign="middle"><input name="is_wifi" type="checkbox" id="is_wifi" value="1" /></td>
