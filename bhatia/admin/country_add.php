<?php session_start();
	...
	$db->connect();	?>
    <?php
	$country=mysql_query("select * from country where Country_Id='".$_REQUEST['eid']."'");
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          <tr>
            <td class="normal_fonts14_black"><a href="country.php">Country Details</a></td>
            </tr>
          <tr>
            <td>
            <?php if($_REQUEST['eid']=='') { ?>
            <form name="frmcountry"  method="post" action="country_process.php">
            <?php } else { ?>
            <form name="frmcountry"  method="post" action="country_process.php?is_edit=1">
            <input type="hidden" name="txtid" value="<?php echo $k['Country_Id']; ?>" />
            <?php } ?>
