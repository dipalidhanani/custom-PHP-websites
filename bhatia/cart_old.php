...
<table width="260" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="81" align="left" valign="top" background="<?php echo HTTP_BASE_URL; ?>images/header_04.jpg" style="background-repeat:no-repeat;"><table width="100%" border="0" cellspacing="3" cellpadding="0">
              <tr>
                <td width="60">&nbsp;</td>
