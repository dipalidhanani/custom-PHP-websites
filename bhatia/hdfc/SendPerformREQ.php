...
$responseURL="responseURL=http://www.bhatiamobile.com/hdfc/GetHandleRES.php";
...
*/ 
$errorURL="errorURL=http://www.bhatiamobile.com/hdfc/FailedTRAN.php";
...
are not utilized */
$udf1="udf1=Mobile Payment";
$udf2="udf2=nirav@indoushosting.com";
$udf3="udf3=9879179174";
$udf4="udf4=Japan Market";
$udf5="udf5=Bhatia Mobile Payment";
...
$response = $data1;
            try
			{
				...
				{
					$failedurl = 'http://www.bhatiamobile.com/hdfc/FailedTRAN.php?message=PAYMENT FAILED ('.$response.' )&ME_TX_ID='.$TranTrackid;
