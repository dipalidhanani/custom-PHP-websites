<?php session_start();
	...
	$db->connect();
	$qry=mysql_query("select * from user_mst where User_Id='".$_SESSION['buserid']."'");
	$k=mysql_fetch_array($qry);
	?>
...
var url="<?php echo HTTP_BASE_URL; ?>admin/statedata.php";
url=url+"?q="+str;
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top" background="<?php echo HTTP_BASE_URL_ORDER; ?>images/box_02.jpg" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            ...
                            <td class="title">Update Profile</td>
                            </tr>
                          </table></td>
                  ...
                  <tr>
                    <td align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="border1">
                      <tr>
                        ...
                        <form name="frmuserreg" method="post" action="<?php echo HTTP_BASE_URL_ORDER; ?>profile_process.php" onsubmit="return validation();">
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="title_10">
                          ...
                          <tr>
                            <td height="10" colspan="3" align="center" valign="middle" bgcolor="#FFFFFF" class="err_msg_11">Your Profile has been updated successfully!!</td>
                          </tr>
                          <?php } ?>
                          <tr>
                            <td height="25" colspan="3" align="left" valign="top" bgcolor="#CCCCCC" class="title_12">&nbsp;Fill Personal Details</td>
                          </tr>
                          <tr>
                            ...
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="110" align="left" valign="middle"><input name="fname" type="text" class="title_10" id="fname"  value="<?php echo $k['First_Name']; ?>"/></td>
                                <td width="110" align="left" valign="middle"><input name="mname" type="text" class="title_10" id="mname"  value="<?php echo $k['Middle_Name']; ?>" /></td>
                                <td width="110" align="left" valign="middle"><input name="lname" type="text" class="title_10" id="lname"  value="<?php echo $k['Last_Name']; ?>"/></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
					...
					for($kk=$yr-1;$kk>=$min;$kk--){ ?>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span class="normal_fonts9">
                              <textarea name="add1" cols="40" rows="4" class="title_10" id="add1"><?php echo $k['Address1']; ?></textarea>
                            </span></td>
                          </tr>
                          <tr>
  ...
  ?>
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top"><span class="normal_fonts9">
                              ...
                              <option value="0">Select One</option>
                              <?php $city_data=mysql_query("SELECT * FROM city_mst WHERE state_id='".$k['State_Id']."' ORDER BY city_name");
                          ...
                          <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#f3f3f3">:</td>
                            <td align="left" valign="top" bgcolor="#f3f3f3"><span class="normal_fonts9">
                              <input name="area" type="text" class="title_10" id="area" value="<?php echo $k['Area']; ?>" />
                            </span></td>
                          </tr>
                          <tr>
                            ...
                            <td align="center" valign="top">:</td>
                            <td align="left" valign="top"><span class="normal_fonts9">
                              <input name="zipcode" type="text" class="title_10" id="zipcode" value="<?php echo $k['Pincode']; ?>" />
                            </span></td>
                          </tr>
                          <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#f3f3f3">:</td>
                            <td align="left" valign="top" bgcolor="#f3f3f3"><span class="normal_fonts9">
                              <input name="email" type="text" class="title_10" id="email" size="30" value="<?php echo $k['Email_Address']; ?>" />
                            </span></td>
                          </tr>
                          <tr>
                            <td height="25" colspan="3" align="left" valign="top" bgcolor="#CCCCCC" class="title_12">&nbsp;Contact Details</td>
                          </tr>
                          <tr>
                            <td align="right" valign="top">Phone No.</td>
                            <td align="center" valign="top">:</td>
                            <td align="left" valign="top"><span class="normal_fonts9">
                              <input name="phone" type="text" class="title_10" id="phone" value="<?php echo $k['Phone']; ?>" />
                            </span></td>
                          </tr>
                          <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#f3f3f3">:</td>
                            <td align="left" valign="top" bgcolor="#f3f3f3"><span class="normal_fonts9">
                              <input name="mobile" type="text" class="title_10" id="mobile" value="<?php echo $k['Mobile']; ?>" />
                            </span></td>
                          </tr>
                          <tr>
                            <td height="25" colspan="3" align="left" valign="top" bgcolor="#CCCCCC" class="title_12">&nbsp;Login Details</td>
                          </tr>
                          <tr>
                            <td align="right" valign="top" bgcolor="#FFFFFF">Username</td>
                            <td align="center" valign="top" bgcolor="#FFFFFF">:</td>
                            <td bgcolor="#FFFFFF" class="normal_fonts9"><input name="username" type="text" class="title_10" id="username" value="<?php echo $k['User_Name']; ?>" readonly="readonly" />
                              </td>
                          </tr>
                          <tr>
                            ...
                            <td align="center" valign="top" bgcolor="#f3f3f3">:</td>
                            <td align="left" valign="top" bgcolor="#f3f3f3"><span class="normal_fonts9">
                              <input name="pass1" type="text" class="title_10" id="pass1"  value="<?php echo base64_decode($k['Password']); ?>"/>
                            </span></td>
                          </tr>
                          <tr>
                            <td colspan="3" align="right" valign="top" height="2"></td>
                          </tr>
                          <tr>
                            <td align="right" valign="top">&nbsp;</td>
                            <td colspan="2" align="left" valign="top"><input name="submit" type="submit" class="title_12" value="Submit" onclick="return validate_email();validate_pass();" />&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="2" colspan="3" align="right" valign="top"></td>
                          </tr>
                        </table>
                        </form>
                        </td>
