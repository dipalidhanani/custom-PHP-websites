...
<table width="985" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="171" align="left" valign="top" background="<?php echo HTTP_BASE_URL_ORDER; ?>images/footer_bg.jpg" bgcolor="#D6D4D5" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <img src="<?php echo HTTP_BASE_URL_ORDER; ?>logo/<?php echo $l['Is_Image']; ?>" height="40"  border="0" />            </td>
            <?php } ?>
            </tr>
			</table>
               </marquee></td>
  ...
  <tr>
    <td height="1"></td>
      ...
      <tr>
        <td height="25" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td width="25%" rowspan="3" align="center"><div id="thawteseal" style="text-align:center;" title="Click to Verify - This site chose Thawte SSL for secure e-commerce and confidential communications.">
...
<div><a href="http://www.thawte.com/products/" target="_blank" style="color:#000000; text-decoration:none; font:bold 10px arial,sans-serif; margin:0px; padding:0px;">ABOUT SSL CERTIFICATES</a></div>
          ...
          <tr>
            <td align="center" class="fonts9">Developed &amp; Managed by V3+ Web Solutions</td>
            </tr>
        </table></td>
      </tr>
