...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#333333"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="288"><a href="<?php echo HTTP_BASE_URL; ?>index.php"><img src="<?php echo HTTP_BASE_URL; ?>images/logo.jpg" width="288" height="100" border="0" /></a></td>
  ...
  <tr>
    <td height="41" align="center" valign="middle" background="<?php echo HTTP_BASE_URL; ?>images/header_07.jpg" style="background-repeat:repeat-x;"><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
