                          ...
                          <tr>
                            ...
                            <td align="left" valign="top" background="<?php echo HTTP_BASE_URL; ?>images/box_02.jpg" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="title"><span class="title_red">Latest</strong></span><strong> Additions</td>
                                    <td align="right" valign="middle">
                                    <?php if($_REQUEST['pageno']!=24) { ?>
                                    <a href="index.php?pageno=24" class="title_10"><strong>View All</strong></a>
                                    <?php } ?>
                                    &nbsp;&nbsp;</td>
                                  </tr>
                                </table></td>
