...
<?php 
$new_query="SELECT *,count(Prod_Id) as d from prod_order_mst GROUP BY Prod_Id order by d desc";
$find_data=mysql_query($new_query);
$rr=mysql_fetch_array($find_data);
$finded_prod_id=$rr['Prod_Id'];
$qry=mysql_query("select * from prod_mst,order_mst,prod_order_mst where prod_mst.Is_Active=1 and prod_order_mst.Order_Id=order_mst.Order_Id and prod_order_mst.Prod_Id=prod_mst.Prod_Id and order_mst.Order_Status='Completed' order by prod_mst.Prod_Id");
$rows=mysql_affected_rows();
if($rows==0)
{
	$qry=mysql_query("select * from prod_mst where Is_Active=1 and Prod_Id='71' order by Prod_Id");
}
                          ...
                          <tr>
                            ...
                            <td align="left" valign="top" background="<?php echo HTTP_BASE_URL; ?>images/box_red_02.jpg" style="background-repeat:repeat-x;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td class="title_w">Best Selling Product</td>
                              </tr>
                            </table></td>
