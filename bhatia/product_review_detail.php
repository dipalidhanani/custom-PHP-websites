		  ...
		  ?>
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td width="100" align="center" valign="top"><img src="<?php echo HTTP_BASE_URL; ?>product/<?php echo $pi['Is_Image']; ?>" width="80" height="100" /></td>
                        <td valign="top"><table width="100%" border="0" cellpadding="2" cellspacing="0">
                        <?php
			$query="SELECT * FROM review_mst WHERE Is_Approve=1 and Prod_Id='".$_REQUEST['eid']."' ORDER BY Review_Id desc";
