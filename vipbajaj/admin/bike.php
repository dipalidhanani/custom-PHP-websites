...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
      ...
      <tr>
        <td class="normal_fonts14_black">Bikes</td>
        <td align="right" class="normal_fonts14_black"><table border="0" cellspacing="0" cellpadding="5">
          <tr>
            ...
            <td class="normal_fonts12_black"><a href="bike.php?action=new">New Bike</a>&nbsp;</td>
          </tr>
        </table></td>
      </tr>
      <?php
      ...
      <tr>
        <td colspan="2"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="border">
          <tr>
            ...
            <td align="left" bgcolor="#999999" class="normal_fonts10"><strong>Bike Model</strong></td>
            <td align="left" bgcolor="#999999" class="normal_fonts10"><strong>Bike Price</strong></td>           
            <td width="10%" align="center" bgcolor="#999999" class="normal_fonts10"><strong>Action</strong></td>
          </tr>
          <?php
		  
		  $query="SELECT * FROM bike_mast where type=0 ";
           ...
           <td class="normal_fonts9" bgcolor="<?php echo $bg;?>"><?php echo $rowcategory["Bike_price"];?></td> 
             ...
             <td align="center" bgcolor="<?php echo $bg;?>"><table border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <a href="bike.php?action=edit&bikeid=<?php echo $rowcategory["Bike_id"];?>"><img src="../images/edit.png" border="0" /></a>
                        </td>
                         <td align="center" valign="top">
                       
                        <a href="bike.php?action=view&bikeid=<?php echo $rowcategory["Bike_id"];?>"><img src="../images/zoom_in.png" border="0" /></a>
                        </td>
                      </tr>
                </table></td>
          </tr>
	  ...
	  ?>
       <tr>
        <td colspan="2">
        <form name="bikeform" id="bikeform" method="post" action="processBike.php?type=0" enctype="multipart/form-data"> 
     ...
     <?php	
	  ...
	  ?>
            ...
            <tr>
              <td width="30%" align="right" class="normal_fonts9">Bike Name</td>
              <td width="1%" align="left" valign="top">:</td>
	 ...
	 $c++;
	  ...
	  ?>
            ...
            <tr>
              <td width="30%" align="right" class="normal_fonts9">Bike Photo</td>
              <td width="1%" align="left" valign="top">:</td>
              <td align="left" valign="top"><input name="bike_photo" id="bike_photo" type="file" class="normal_fonts9" size="45" /></td>
              </tr>
              <tr bgcolor="#F3F3F3">
              <td width="30%" align="right" class="normal_fonts9">Additional Bike Photo 1</td>
              <td width="1%" align="left" valign="top">:</td>
              ...
              <tr>
              <td width="30%" align="right" class="normal_fonts9">Additional Bike Photo 2</td>
              <td width="1%" align="left" valign="top">:</td>
              ...
              <tr bgcolor="#F3F3F3">
              <td width="30%" align="right" class="normal_fonts9">Additional Bike Photo 3</td>
              <td width="1%" align="left" valign="top">:</td>
            ...
            <tr>
              <td width="30%" align="right"  class="normal_fonts9">Bike Price</td>
              <td width="1%" align="left" valign="top">:</td>
      ...
      <tr>
        ...
        <form name="bikeform" method="post" action="processBike.php?type=0" enctype="multipart/form-data">
        <?php
	 ...
	 $c++;
	  ...
	  ?>
              ...
              <tr>
              <td width="30%" align="right" valign="top" class="normal_fonts9">Bike Photo</td>
              <td width="1%" align="left" valign="top">:</td>
              <td align="left" valign="top">
            ...
            <tr>
              <td width="30%" align="right" valign="top" class="normal_fonts9">Edit Bike Photo</td>
              <td width="1%" align="left" valign="top">:</td>
