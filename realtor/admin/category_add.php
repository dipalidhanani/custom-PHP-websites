...
function validation_category()
{
	with(document.categoryform)
	{
			...
			{
				error=1;
				message=message + "\n" + "Please Select Category Display Image !";
			}
          ...
          <tr>
            <td><form name="categoryform" id="categoryform" action="category_process.php" method="post" enctype="multipart/form-data">
              ...
              <tr bgcolor="#F3F3F3">
                ...
                <td valign="top" class="normal_fonts9"><input name="cat_name" id="cat_name" type="text" class="normal_fonts9"  size="45"  /></td>
              </tr>
               <tr>
                <td width="300" align="right" valign="top" class="normal_fonts9">Category Display Image</td>
                <td width="10" align="center" class="normal_fonts9">:</td>
                <td valign="top" class="normal_fonts9">
               <input name="display_image" id="display_image" type="file" class="normal_fonts8" />&nbsp;&nbsp;(width : 220px x height : 119px)
                </td>
              </tr>
              <tr>
              ...
              <tr>
               ...
               <tr bgcolor="#F3F3F3">
                ...
                <td align="center" valign="top" class="normal_fonts9">:</td>
                <td valign="top" class="normal_fonts9"><input name="category_display_order" id="category_display_order" type="text" class="normal_fonts9" size="45" /></td>
              </tr>
              <tr>
                <td align="right" valign="top" class="normal_fonts9">Active</td>
                <td align="center" class="normal_fonts9">:</td>
                <td valign="top" class="normal_fonts9"><input type="radio" name="cat_status" value="1" checked="checked" />Yes&nbsp;
