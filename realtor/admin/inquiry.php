...
$query="select * from inquiry_master order by inquiry_ID desc ";
...
<table width="99%" border="0" cellspacing="10" cellpadding="0" >    
    <tr>
            <td class="normal_fonts14_black">Quick Inquiry</td>
    </tr>
     <tr>
       <td bgcolor="#CCCCCC">
  <?php 
...
<tr>
  ...
  <td width="10%" align="left" valign="middle" bgcolor="#999999"><strong>Email</strong></td>
                <td width="10%" align="left" valign="middle" bgcolor="#999999"><strong>Contact No</strong></td>
                <td align="left" valign="middle" bgcolor="#999999"><strong>Message</strong></td>
                <td width="15%" align="center" valign="middle" bgcolor="#999999"><strong>Datetime</strong></td>
                <td width="10%" align="center" valign="middle" bgcolor="#999999"><strong>IP</strong></td>
                </tr>
<?php 
$i=1;
...
<td bgcolor="<?php echo $bg;?>"><?php echo $row["inquiry_contact_no"];?></td>
<td bgcolor="<?php echo $bg;?>"><?php echo $row["inquiry_message"];?></td>
<td align="center" bgcolor="<?php echo $bg;?>"><?php echo explodedate($row["inquiry_datetime"]);?></td>
<td align="center" bgcolor="<?php echo $bg;?>"><?php echo $row["inquiry_ip_address"];?></td>
</tr>
...
if ($pagenum == $last) 
				...
				{				
				?>				
    <a href='inquiry.php?pagenum=<?php echo $i; ?>'><?php echo $i; ?></a> | 
    <?php
				}		
				}		
				}
    ...
    <?php
				...
				{
			?>
    <a href='inquiry.php?pagenum=<?php echo $pagenum+1; ?>'>Next</a>&nbsp;&nbsp;
    <a href='inquiry.php?pagenum=<?php echo $last; ?>'>Last >> </a>	
    <?php
				}
			}
				?>    </td>
