...
<td align="left" valign="middle" bgcolor="#999999"><strong>Email</strong></td>
                ...
                <td width="10%" align="center" valign="middle" bgcolor="#999999"><strong>Active</strong></td>
                 <td width="7%" align="center" valign="middle" bgcolor="#999999"><strong>Action</strong></td>
                </tr>
<?php 
$i=1;
...
?>
 ...
 <td align="center" bgcolor="<?php echo $bg;?>"><table border="0" cellspacing="1" cellpadding="1">
                      <tr>                       
						...
						{						
						?>
                        <a href="process.php?process=removenewsletter&newsletter_subscriber_ID=<?php echo $row["newsletter_subscriber_ID"]?>" onClick="return confirm('Do you want to remove selected Newsletter Subscriber?');"><img src="images/delete_on.gif" border="0" /></a>
                        <?php
						}
						else
						{
...
{
?>
    <a href='newsletter_subscriber.php?pagenum=1' > << first      </a>
    <a href='newsletter_subscriber.php?pagenum=<?php echo $pagenum-1; ?>'>Previous      </a>	
    <?php
}
if ($pagenum == $last) 
				{
				...
				{				
				?>				
    <a href='newsletter_subscriber.php?pagenum=<?php echo $i; ?>'><?php echo $i; ?></a> | 
    <?php
				}		
				}		
				}
    ...
    <?php
				...
				{
			?>
    <a href='newsletter_subscriber.php?pagenum=<?php echo $pagenum+1; ?>'>Next</a>&nbsp;&nbsp;
    <a href='newsletter_subscriber.php?pagenum=<?php echo $last; ?>'>Last >> </a>	
    <?php
				}
			}
				?>    </td>
