...
<table width="99%" border="0" cellspacing="10" cellpadding="0" >    
    <tr>
            <td class="normal_fonts14_black">Catalogue Inquiry</td>
    </tr>
     <tr>
       <td bgcolor="#CCCCCC">
  <?php 
...
INNER JOIN catalogue_master ON catalogue_master.catalogue_id=inquiry.inquiry_forid
where inquiry_for=2 order by inquiry_id desc ";
...
<td bgcolor="<?php echo $bg;?>"><?php echo "Catalogue - ".$row["catalogue_name"];?></td>
</tr>
...
if ($pagenum == $last) 
				...
				{				
				?>				
    <a href='inquiry_catalogue.php?pagenum=<?php echo $i; ?>'><?php echo $i; ?></a> | 
    <?php
				}		
				}		
				}
    ...
    <?php
				...
				{
			?>
    <a href='inquiry_catalogue.php?pagenum=<?php echo $pagenum+1; ?>'>Next</a>&nbsp;&nbsp;
    <a href='inquiry_catalogue.php?pagenum=<?php echo $last; ?>'>Last >> </a>	
    <?php
				}
			}
				?>    </td>
