...
<form name="AffordFORM" method="get" action="/index.php">
<input name="io_listing_afford" value="" type="hidden">
<input name="io_gds" value="32" type="hidden">
<table width="86%"  border="0" cellpadding="0" cellspacing="10" class="moduleHighlight1">
<tbody>
<tr>
                            <td class="title_red" colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td width="25"><img src="images/arrow1.png" width="19" height="18"></td>
                                    <td class="title_red"><strong>Mortgage Calculator</strong></td>
                              </tr>
                                </table></td>
</tr>
<tr>
<td width="22%" align="left" class="black10">Asking Price:</td>
<td width="27%" class="black10">$<input name="io_price" class="black10" size="15" type="text"></td>
<input name="io_heating" class="black10" size="15" value="0" type="hidden">
<td width="24%" align="right" class="black10">Annual Taxes:</td><td width="27%">$<input name="io_taxes" class="black10" size="10" type="text"></td>
</tr>
<tr>
<td align="left" class="black10">Interest Rate: </td>
<td class="black10"><input name="io_interest" class="black10" size="10" value="4.0" type="text">%</td>
<td align="right" class="black10">Monthly Condo Fees:</td>
<td class="black10">$<input name="io_condo" class="black10" size="10" type="text"></td>
</tr>
<tr>
<td align="left" class="black10">Amortization: </td>
<td class="black10"><select name="io_amortization" onChange="doCalc();" class="black10" size="1"><option value="5">5 Years</option><option value="10">10 Years</option><option value="15">15 Years</option><option value="20">20 Years</option><option value="25" selected="selected">25 Years</option><option value="30">30 Years</option></select>
</td>
</tr>
<tr>
<td colspan="4" class="black10">
<p style="text-align:center;"><i>CMHC will not insure amortization terms of over 25 years.</i></p>
</td>
</tr>
<tr>
<td colspan="4" align="center"><input class="button" onClick="doCalc();" value="Calculate" type="button"></td>
</tr>
</tbody>
</table>
<!-- START TABLE -->
<table width="523" border="0" cellpadding="0" cellspacing="10">

<tbody><tr>
<td width="137" align="left" class="moduleHighlight black10" >
<strong>Down Payment</strong>: </td>
<td width="117" class="moduleHighlight black10" >
$<input size="10"  name="down_payment1" value="5000" type="text" class="black10"></td>

<td width="135" class="moduleHighlight">
$<input size="10"  name="down_payment2" value="25000" type="text" class="black10"></td>

<td width="108" class="moduleHighlight">
$<input size="10"  name="down_payment3" value="50000" type="text" class="black10"></td>
</tr>

<tr>
<td align="left" class="black10">Percent Down: </td>
<td align="left" class="black10">&nbsp;&nbsp;
<input size="5" name="percent_down1" type="text" class="black10">%
</td>

<td align="left" class="black10">&nbsp;&nbsp;
<input size="5"  name="percent_down2" type="text" class="black10">%
</td>

<td align="left" class="black10">&nbsp;&nbsp;
<input size="5" name="percent_down3" type="text" class="black10">%
</td>
</tr>
...
First Mortgage: </td>
<td class="black10">
$<input size="10"  name="first_mortgage1" type="text" class="black10"></td>

<td class="black10">
$<input size="10"  name="first_mortgage2" type="text" class="black10"></td>

<td class="black10">
$<input size="10"  name="first_mortgage3" type="text" class="black10"></td>
</tr>
...
CMHC Premium: </td>
<td>
$<input size="10" class="black10" name="cmhc1" type="text"></td>
<td>
$<input size="10" class="black10" name="cmhc2" type="text"></td>
<td>
$<input size="10" class="black10" name="cmhc3" type="text"></td>
</tr>
...
Total Financing: </td>
<td>
$<input size="10" class="black10" name="total_financing1" type="text"></td>
<td>
$<input size="10" class="black10" name="total_financing2" type="text"></td>
<td>
$<input size="10" class="black10" name="total_financing3" type="text"></td>
</tr>
...
Monthly Payment: </td>
<td>
$<input size="10" class="black10" name="monthly_payment1" type="text"></td>
<td>
$<input size="10" class="black10" name="monthly_payment2" type="text"></td>
<td>
$<input size="10" class="black10" name="monthly_payment3" type="text"></td>
</tr>
...
Taxes / Fees: </td>
<td>
$<input size="10" class="black10" name="expenses1" type="text"></td>
<td>
$<input size="10" class="black10" name="expenses2" type="text"></td>
<td>
$<input size="10" class="black10" name="expenses3" type="text"></td>
</tr>
...
Total Payment: </td>
<td>
$<input size="10" class="black10" name="total_payment1" type="text"></td>
<td>
$<input size="10" class="black10" name="total_payment2" type="text"></td>
<td>
$<input size="10" class="black10" name="total_payment3" type="text"></td>
</tr>
...
Income Required: </td>
<td>
$<input size="10" class="black10" name="income_required1" type="text"></td>
<td>
$<input size="10" class="black10" name="income_required2" type="text"></td>
<td>
$<input size="10" class="black10" name="income_required3" type="text"></td>
</tr>
