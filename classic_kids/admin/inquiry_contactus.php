...
<title>Welcome to Klassic Kids - Inquiry</title>
...
<table width="99%" border="0" cellspacing="10" cellpadding="0" >    
    <tr>
            <td class="normal_fonts14_black">Contact us Inquiry</td>
    </tr>
     <tr>
       <td bgcolor="#CCCCCC">
  <?php 

$query="select * from contactus_inquiry order by inquiry_id desc ";
