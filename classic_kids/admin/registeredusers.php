      ...
      <div class="highslide-maincontent">
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
              ...
              <tr>
                        ...
                        <tr>
                          <td align="right" valign="top" class="normal_fonts9" >Unit  </td>
                          <td class="normal_fonts9">:</td>
                          <td class="normal_fonts9"><?php  echo $row["register_user_unit"];?></td>
                        </tr> 
                        <?php if($row["register_user_street"]!=""){ ?>
                         <tr>
                          <td align="right" valign="top" class="normal_fonts9" >Street</td>
                          <td class="normal_fonts9">:</td>
                          <td class="normal_fonts9"><?php  echo $row["register_user_street"];?></td>
                        </tr>
                        <?php } ?>                        
                        <tr>
                          <td align="right" valign="top" class="normal_fonts9" >Subburb  </td>
                          <td class="normal_fonts9">:</td>
                          <td class="normal_fonts9"><?php  echo $row["register_user_subburb"];?></td>
                        </tr>
                        ...
                        <tr>
                         ...
                         <?php if($row["register_user_phone"]!=""){ ?>
                        <tr>
