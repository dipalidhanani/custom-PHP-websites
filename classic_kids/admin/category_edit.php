          ...
          <tr>
            ...
            <input type="hidden" name="category_ID" id="category_ID" value="<?php echo $_REQUEST["catid"]; ?>"  />
              ...
              <tr>
                ...
                <td align="center" valign="top" bgcolor="#F3F3F3" class="normal_fonts9">:</td>
                <td valign="top" bgcolor="#F3F3F3" class="normal_fonts9"><input type="radio" name="cat_status" value="1" <?php if($rowcat["category_active_status"]==1) { ?> checked="checked" <?php } ?> />Yes&nbsp;<input type="radio" name="cat_status" value="0" <?php if($rowcat["category_active_status"]==0) { ?> checked="checked" <?php } ?> />No</td>
              </tr>
               <tr>
                <td align="right" valign="top" class="normal_fonts9">Display Order </td>
                <td align="center" valign="top" class="normal_fonts9">:</td>
                <td valign="top" class="normal_fonts9"><input type="text" name="cat_display_order" id="cat_display_order" value="<?php echo $rowcat["cat_display_order"]; ?>" ></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <input type="hidden" name="StartFrom" value="<?php echo $_REQUEST["StartFrom"]; ?>"/>
                      ...
                      <input type="submit" name="Submit" value="Change"  onClick="return validation_category()" class="normal_fonts12_black"/></td>
              </tr>
              <tr>
                <td height="10" colspan="3" align="right" class="normal_fonts9"></td>
                </tr>
